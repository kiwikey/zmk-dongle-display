...
lv_obj_t *zmk_display_status_screen() { // CHANGED!!!
    ...
    lv_obj_align(zmk_widget_bongo_cat_obj(&bongo_cat_widget), LV_ALIGN_BOTTOM_LEFT, 0, 0); // CHANGED

    zmk_widget_modifiers_init(&modifiers_widget, screen);
    lv_obj_align(zmk_widget_modifiers_obj(&modifiers_widget), LV_ALIGN_BOTTOM_RIGHT, 0, 0); // CHANGED
    ...
    lv_obj_align_to(zmk_widget_layer_status_obj(&layer_status_widget), zmk_widget_modifiers_obj(&bongo_cat_widget), LV_ALIGN_TOP_LEFT, 0, -12); // CHANGED
...
/*** BELOW IS DEFAULT WIDGETS' POSITIONING ***
...
lv_obj_t *zmk_display_status_screen() {
    ...
    zmk_widget_bongo_cat_init(&bongo_cat_widget, screen);
    lv_obj_align(zmk_widget_bongo_cat_obj(&bongo_cat_widget), LV_ALIGN_BOTTOM_RIGHT, 0, -12);
